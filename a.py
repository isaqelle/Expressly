...
"")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../Pictures/grinning-face-with-big-eyes_1f603.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.VeryHappy.setIcon(icon)
        self.VeryHappy.setIconSize(QtCore.QSize(55, 55))
        self.VeryHappy.setAutoRepeat(False)
        self.VeryHappy.setAutoRepeatDelay(299)
        ...
        self.Happy.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../Pictures/slightly-smiling-face_1f642.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.Sad.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../Pictures/crying-face_1f622.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Sad.setIcon(icon2)
        self.Sad.setIconSize(QtCore.QSize(55, 55))
        self.Sad.setAutoRepeat(False)
        self.Sad.setAutoRepeatDelay(299)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../Pictures/neutral-face_1f610.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.Angry.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../Pictures/pouting-face_1f621.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.tired.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../Pictures/sleeping-face_1f634.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../Downloads/image0.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("../Downloads/image1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
